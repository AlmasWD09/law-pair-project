                ...
                <div className="container mx-auto px-4 flex items-center">
                    <nav className="relative container flex justify-between items-center w-full">
                        ...
                        text-[#FFFFFF] px-[24px] font-bold font-roboto flex items-center gap-2">
                                                        <span className="inline-flex items-center text-xs">{lawyerData?.full_name}</span>
                        ...
                        text-[#FFFFFF] px-[24px] font-bold font-roboto flex items-center gap-2">
                                                ...
                                                <Link to="/create-account">
                                                    <button className="h-[48px] bg-primary rounded-[4px] text-[16px] 
                            text-[#FFFFFF] px-[24px] font-bold font-roboto flex items-center gap-2">
                                                        <span className="inline-flex items-center text-xs">Create an Account</span>
                            ...
                            <div className="flex items-center gap-4">
                                {
                                    lawyerToken ? (
                                        <Link to="/lawyer-profile">
                                            <button className="h-[48px] bg-primary rounded-[4px] text-[16px] 
                        text-[#FFFFFF] px-[24px] font-bold font-roboto flex items-center gap-2">
                                                <span className="inline-flex items-center">{lawyerData?.full_name}</span>
                                                <img src={lawyerData?.avatar} alt="" className="w-8 h-8 rounded-full object-cover" />
                                            </button>
                                        </Link>
                                    ) : userToken ? (
