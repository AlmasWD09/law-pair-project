            ...
            <div className="max-w-[684px] bg-[#FFFFFF] p-10 lg:px-20 py-8">
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex flex-col justify-center items-center pb-10 md:pb-[78px]">
                        <h1 className="font-roboto text-[#121221] font-semibold text-[20px] md:text-[36px] pt-[40px] pb-[20px]">OTP Verification</h1>
                        <p className="font-roboto text-[18px] text-[#929299]">We have sent a verification code to william***@gmail.com</p>
                    </div>
                </div>
