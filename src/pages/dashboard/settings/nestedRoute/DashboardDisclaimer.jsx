...
const DashboardDisclaimer = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg max-w-full">
      <div>
        <h1 className="font-roboto text-[20px] md:text-[40px] font-bold text-[#10101E]">Disclaimer</h1>
        <p className="fontro text-[#B6B6BA] text-[12px] pb-3">Admin can edit disclaimer</p>
        ...
        <div className="mt-4">
          ...
          <p className="fontro text-[#B6B6BA] text-[12px] pb-3">Admin write about disclaimer</p>
