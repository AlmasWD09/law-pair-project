            ...
            <div className="max-w-[1037px] lg:h-[789px] mx-auto overflow-hidden bg-white rounded-lg shadow-md p-4">
              ...
              <div>
                ...
                <div className="space-y-3 pt-[8px">
                  {phone && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3 pt-[8px]">
                    {/* <svg
                      width="24"
                      height="25"
                      viewBox="0 0 12 16"
                  ...
                  {email && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3"> 
                    {/* <svg
                      width="24"
                      height="25"
                      viewBox="0 0 24 25"
                  ...
                  {practice_area && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3"> 
                    {/* <svg
                      width="24"
                      height="25"
                      viewBox="0 0 24 25"
                  ...
                  {/* {
                    id_number && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3">
                  ...
                  {/* {address && <p className="font-roboto text-[16px] text-[#10101E] flex gap-3">
                    <svg
                      width="24"
                      height="25"
                      viewBox="0 0 24 25"
                  ...
                  {languages && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3 "> 
                    {/* <svg
                      width="24"
                      height="25"
                      viewBox="0 0 24 25"
                  ...
                  {
                    web_link && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3 "> 
                      {/* <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  {
                    linkedin_url && <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3 "> 
                ...
                <div className="flex flex-wrap lg:flex-row items-center gap-3 pt-3">
                  {lawyerAllData?.schedule?.map((item) => {
                    return (
                      <button
                        className={`border px-4 py-2 rounded-full font-roboto text-primary text-[16px] ${item?.time ? "bg-primary text-white" : ""
                          }`}
                      >
                        {item.day} {item.time}
                      </button>
