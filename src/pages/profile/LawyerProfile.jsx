                    ...
                    <div>
                        <div className="max-w-[1037px] lg:h-[989px] mx-auto overflow-hidden bg-white rounded-lg shadow-md p-4">
                            ...
                            <div className="pb-[24px]">
                                <h1 className="text-[20px] font-bold font-roboto text-[#001018]">John Peterson</h1>
                                <h3 className="text-[14px] font-roboto text-[#001018]">Immigration</h3>
                            </div>
                            <hr />
                            ...
                            <div>
                                ...
                                <div className="space-y-3 pt-[8px">
                                    ...
                                    <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3 ">
                                        ...
                                        <Link to={'/www.websitedomain.com'} className="text-primary underline">www.websitedomain.com</Link></p>
                                </div>
