...
const AttorneyTm = () => {
    ...
    const handleFavoriteList = async (id) => {
        ...
        if (userToken) {
            try {
                const response = await axiosPublic.post('/user/mark-as-favorite', favoriteInfo, {
                    headers: {
                                    ...
                                    return (
                                        <div key={index} className="w-[300px] h-[378px] p-4 shadow-lg rounded-md">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                {attorney.is_favorite === false ? <span><FaRegCheckCircle
                                                    onClick={() => handleFavoriteList(attorney.id)}
                                                    className="cursor-pointer" /></span>
                                                    :
                                                    <span onClick={() => handleFavoriteList(attorney.id)}
