        ...
        <div className="max-w-[1037px] mx-auto overflow-hidden bg-white rounded-lg shadow-md p-4 mt-10">
          <div className="flex justify-between items-center md:items-start pb-[12px] ">
            ...
            <div className="md:flex items-center md:gap-4">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 pt-4 md:pt-0">
                {/* email */}
                ...
                {/* whats'app */}
                <a href={`https://wa.me/${lawyerData.phone}`} target="_blank">
          ...
          <div>
            ...
            <div className="space-y-3 pt-[8px">
              ...
              <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3">
                ...
                {lawyerData.experience} experience
              </p>
              ...
              <p className="font-roboto text-[16px] text-[#10101E] flex gap-3">
                ...
                456 Justice Avenue, Suite 890 <br /> Central Legal District{" "}
                <br /> Los Angeles, CA 90017 <br /> United States
              </p>
              <p className="font-roboto text-[16px] text-[#10101E] flex items-center gap-3 ">
                <svg
                  width="24"
